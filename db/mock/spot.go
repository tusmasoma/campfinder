...
func (m *MockSpotRepository) CheckIfSpotExists(ctx context.Context, lat, lng float64, opts ...db.QueryOptions) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockSpotRepository) Create(ctx context.Context, spot db.Spot, opts ...db.QueryOptions) error {
	m.ctrl.T.Helper()
...
func (m *MockSpotRepository) Delete(ctx context.Context, spot db.Spot, opts ...db.QueryOptions) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, spot}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockSpotRepository) GetSpotByCategory(ctx context.Context, category string, opts ...db.QueryOptions) ([]db.Spot, error) {
	m.ctrl.T.Helper()
...
func (m *MockSpotRepository) UpdateOrCreate(ctx context.Context, spot db.Spot, opts ...db.QueryOptions) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, spot}
	for _, a := range opts {
		varargs = append(varargs, a)
